...
Dodaj na stronę https://bartoszosiej.github.io/talus-process-monitor/ (landing page projektu Talus) linki do sklepów i upewnij się, że wszystko działa.

Link główny (Polar checkout — Talus Process Monitor Enterprise License, $50 one-time):

```
https://buy.polar.sh/polar_cl_28JLJCk73sd8ugcsFrruInxtZo3uoU4ZgOJ3o3NjTJF
```
